...
module.exports.controlDatabaseGasolinera = function() {
    if (!process.env.gasolinera || !process.env.gasolineradatabase || process.env.gasolineradatabase == "") {
        return false;
    } else {
        return true;
    }
...
module.exports.controlDatabaseTelefonia = function() {
    if (!process.env.telefonia || !process.env.telefoniadatabase || process.env.telefoniadatabase == "") {
        return false;
    } else {
        return true;
    }
...
module.exports.controlDatabaseTienda = function() {
    if (!process.env.tienda || !process.env.tiendadatabase || process.env.tiendadatabase == "") {
        return false;
    } else {
        return true;
    }
...
module.exports.controlDatabaseTratamientos = function() {
    if (!process.env.tratamientos || !process.env.tratamientosdatabase || process.env.tratamientosdatabase == "") {
        return false;
    } else {
        return true;
    }
