...
module.exports.postPrepararCorreos = function (numalbar, campanya, done) {
    crearPdfsClasif(numalbar, campanya,(err, result) => {
...
var crearPdfsClasif = function (numalbar, campanya, callback) {
    ...
    con.query(sql, function (err, result) {
        ...
        clasif = result;
            ...
            report.renderAsync(function () {
                ...
                fs.writeFile(config2.clasif_dir + "\\" + numalbar + ".pdf", buffer, function(){
                    if(err) return callback(err, null);
                });
