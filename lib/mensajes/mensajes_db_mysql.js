...
module.exports.postPrepararCorreos = function (numalbar, done) {
    crearPdfsFactura(numalbar, (err, clasif) => {
...
var crearPdfsFactura = function (numalbar, callback) {
    ...
    con.query(sql, function (err, result) {
        ...
        async.forEachSeries(clasif, function (f, done1) {
            ...
            report.renderAsync(function () {
                ...
                fs.writeFileSync(config2.clasif_dir + "\\clasif_tmp.pdf", buffer);
                facturas2.push(f);
                done1();
            });
