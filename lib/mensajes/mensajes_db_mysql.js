...
var fnObtainPlayersIds = function(mensaje, callback) {
    ...
    if ((!mensaje.usuarios || mensaje.usuarios.length == 0) && !mensaje.ariagro && !mensaje.telefonia && !mensaje.tienda && !mensaje.gasolinera && !mensaje.fichero && !mensaje.soloMensajes) {
