        ...
        con2.query(sql2, function(err,lineas) {
            ...
            con2Bis.query(sql2Bis, function(err,lineasBis) {
                ...
                con3.query(sql3, function(err,pie) {
                    ...
                    sql4 += " LEFT JOIN  (SELECT numfactu, fecfactu, codtipom, SUM(totalfac) AS totalVarias FROM fvarcabfact GROUP BY numfactu) AS v ON  v.numfactu = var.numfactufvar AND v.fecfactu = var.fecfactufvar AND v.codtipom = var.codtipomfvar";
