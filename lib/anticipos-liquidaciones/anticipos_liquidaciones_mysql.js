    ...
    con.query(sql, function (err, cab) {
        ...
        con2.query(sql2, function(err,lineas) {
            ...
            con2Bis.query(sql2Bis, function(err,lineasBis) {
                ...
                var sqlgas = " SELECT SUM(imporgasto) AS gasto FROM rfactsoc_albaran WHERE  numfactu = ? AND codtipom LIKE ?"
        ...
        con2.query(sql2, function(err,lineas) {
            ...
            con2Bis.query(sql2Bis, function(err,lineasBis) {
                ...
                con3.query(sql3, function(err,pie) {
                    ...
                    sql4 += " WHERE var.numfactu = ? AND var.codtipom LIKE ? GROUP BY var.numfactufvar, var.codtipomfvar";
