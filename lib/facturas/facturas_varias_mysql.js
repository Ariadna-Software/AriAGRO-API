...
module.exports.getFacturasVariasCliente = function(codclien, year, codsocio, campanya, callback) {
    var facturas = [];
    ...
    sql += " WHERE f.codclien = ? AND f.fecfactu = ?";
    ...
    //}
    sql += " ORDER BY f.fecfactu DESC, f.codtipom, f.numfactu, lf.codtipoa, lf.numlinea;";
